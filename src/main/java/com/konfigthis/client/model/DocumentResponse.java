...
public class DocumentResponse {
  ...
  private List<DocumentResponseRecipientsInner> recipients = null;
  ...
  public DocumentResponse testMode(Boolean testMode) {
  ...
  **/
  ...
  public DocumentResponse apiApplicationId(UUID apiApplicationId) {
  ...
  **/
  ...
  public DocumentResponse requesterEmailAddress(String requesterEmailAddress) {
  ...
  **/
  ...
  public DocumentResponse customRequesterName(String customRequesterName) {
  ...
  **/
  ...
  public DocumentResponse customRequesterEmail(String customRequesterEmail) {
  ...
  **/
  ...
  public DocumentResponse subject(String subject) {
  ...
  **/
  ...
  public DocumentResponse metadata(Object metadata) {
  ...
  **/
  ...
  public DocumentResponse recipients(List<DocumentResponseRecipientsInner> recipients) {
  ...
  public DocumentResponse addRecipientsItem(DocumentResponseRecipientsInner recipientsItem) {
  ...
  **/
  ...
  public List<DocumentResponseRecipientsInner> getRecipients() {
    return recipients;
  }


  public void setRecipients(List<DocumentResponseRecipientsInner> recipients) {
  ...
  **/
  ...
  public DocumentResponse reminders(Boolean reminders) {
  ...
  **/
  ...
  public DocumentResponse archived(Boolean archived) {
  ...
  **/
  ...
  public DocumentResponse embedded(Boolean embedded) {
  ...
  **/
  ...
  public DocumentResponse embeddedEditUrl(String embeddedEditUrl) {
  ...
  **/
  ...
  public DocumentResponse embeddedPreviewUrl(String embeddedPreviewUrl) {
  ...
  **/
  ...
  public DocumentResponse applySigningOrder(Boolean applySigningOrder) {
  ...
  **/
  ...
  public DocumentResponse redirectUrl(String redirectUrl) {
  ...
  **/
  ...
  public DocumentResponse declineRedirectUrl(String declineRedirectUrl) {
  ...
  **/
  ...
  public DocumentResponse expiresIn(Integer expiresIn) {
  ...
  **/
  ...
  public DocumentResponse attachmentRequests(List<DocumentResponseAttachmentRequestsInner> attachmentRequests) {
  ...
  public DocumentResponse addAttachmentRequestsItem(DocumentResponseAttachmentRequestsInner attachmentRequestsItem) {
  ...
  **/
  ...
  public DocumentResponse files(List<DocumentResponseFilesInner> files) {
  ...
  public DocumentResponse addFilesItem(DocumentResponseFilesInner filesItem) {
    if (this.files == null) {
  ...
  **/
  ...
  public DocumentResponse copiedContacts(List<DocumentResponseCopiedContactsInner> copiedContacts) {
  ...
  public DocumentResponse addCopiedContactsItem(DocumentResponseCopiedContactsInner copiedContactsItem) {
  ...
  **/
  ...
  public DocumentResponse fields(List<List<DocumentResponseFieldsInnerInner>> fields) {
  ...
  public DocumentResponse addFieldsItem(List<DocumentResponseFieldsInnerInner> fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public DocumentResponse allowDecline(Boolean allowDecline) {
  ...
  **/
  ...
  public DocumentResponse allowReassign(Boolean allowReassign) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.testMode, documentResponse.testMode) &&
        Objects.equals(this.id, documentResponse.id) &&
        Objects.equals(this.apiApplicationId, documentResponse.apiApplicationId) &&
        Objects.equals(this.requesterEmailAddress, documentResponse.requesterEmailAddress) &&
        Objects.equals(this.customRequesterName, documentResponse.customRequesterName) &&
        Objects.equals(this.customRequesterEmail, documentResponse.customRequesterEmail) &&
        Objects.equals(this.name, documentResponse.name) &&
        Objects.equals(this.subject, documentResponse.subject) &&
        ...
        Objects.equals(this.recipients, documentResponse.recipients) &&
        Objects.equals(this.status, documentResponse.status) &&
        Objects.equals(this.reminders, documentResponse.reminders) &&
        Objects.equals(this.archived, documentResponse.archived) &&
        Objects.equals(this.embedded, documentResponse.embedded) &&
        Objects.equals(this.embeddedEditUrl, documentResponse.embeddedEditUrl) &&
        Objects.equals(this.embeddedPreviewUrl, documentResponse.embeddedPreviewUrl) &&
        Objects.equals(this.applySigningOrder, documentResponse.applySigningOrder) &&
        Objects.equals(this.redirectUrl, documentResponse.redirectUrl) &&
        Objects.equals(this.declineRedirectUrl, documentResponse.declineRedirectUrl) &&
        Objects.equals(this.expiresIn, documentResponse.expiresIn) &&
        Objects.equals(this.attachmentRequests, documentResponse.attachmentRequests) &&
        Objects.equals(this.files, documentResponse.files) &&
        Objects.equals(this.copiedContacts, documentResponse.copiedContacts) &&
        Objects.equals(this.fields, documentResponse.fields) &&
        Objects.equals(this.allowDecline, documentResponse.allowDecline) &&
        Objects.equals(this.allowReassign, documentResponse.allowReassign)&&
        Objects.equals(this.additionalProperties, documentResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(testMode, id, apiApplicationId, requesterEmailAddress, customRequesterName, customRequesterEmail, name, subject, message, metadata, createdAt, updatedAt, recipients, status, reminders, archived, embedded, embeddedEditUrl, embeddedPreviewUrl, applySigningOrder, redirectUrl, declineRedirectUrl, expiresIn, attachmentRequests, files, copiedContacts, fields, allowDecline, allowReassign, additionalProperties);
  }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ...
        if (jsonArrayrecipients != null) {
          ...
          for (int i = 0; i < jsonArrayrecipients.size(); i++) {
            DocumentResponseRecipientsInner.validateJsonObject(jsonArrayrecipients.get(i).getAsJsonObject());
          };
        }
      }
