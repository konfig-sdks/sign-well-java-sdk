...
import com.konfigthis.client.model.DocumentTemplateResponseCopiedPlaceholdersInner;
import com.konfigthis.client.model.DocumentTemplateResponsePlaceholdersInner;
...
public class DocumentTemplateResponse {
  ...
  private List<DocumentTemplateResponsePlaceholdersInner> placeholders = null;
  ...
  private List<DocumentTemplateResponseCopiedPlaceholdersInner> copiedPlaceholders = null;
  ...
  private List<List<DocumentResponseFieldsInnerInner>> fields = null;
  ...
  public DocumentTemplateResponse id(String id) {
  ...
  **/
  ...
  public DocumentTemplateResponse apiApplicationId(UUID apiApplicationId) {
  ...
  **/
  ...
  public DocumentTemplateResponse requesterEmailAddress(String requesterEmailAddress) {
  ...
  **/
  ...
  public DocumentTemplateResponse customRequesterName(String customRequesterName) {
  ...
  **/
  ...
  public DocumentTemplateResponse customRequesterEmail(String customRequesterEmail) {
  ...
  **/
  ...
  public DocumentTemplateResponse name(String name) {
  ...
  **/
  ...
  public DocumentTemplateResponse subject(String subject) {
  ...
  **/
  ...
  public DocumentTemplateResponse message(String message) {
  ...
  **/
  ...
  public DocumentTemplateResponse metadata(Object metadata) {
  ...
  **/
  ...
  public DocumentTemplateResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public DocumentTemplateResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public DocumentTemplateResponse placeholders(List<DocumentTemplateResponsePlaceholdersInner> placeholders) {
  ...
  public DocumentTemplateResponse addPlaceholdersItem(DocumentTemplateResponsePlaceholdersInner placeholdersItem) {
  ...
  **/
  ...
  public List<DocumentTemplateResponsePlaceholdersInner> getPlaceholders() {
    return placeholders;
  }


  public void setPlaceholders(List<DocumentTemplateResponsePlaceholdersInner> placeholders) {
  ...
  public DocumentTemplateResponse copiedPlaceholders(List<DocumentTemplateResponseCopiedPlaceholdersInner> copiedPlaceholders) {
  ...
  public DocumentTemplateResponse addCopiedPlaceholdersItem(DocumentTemplateResponseCopiedPlaceholdersInner copiedPlaceholdersItem) {
  ...
  **/
  ...
  public List<DocumentTemplateResponseCopiedPlaceholdersInner> getCopiedPlaceholders() {
    return copiedPlaceholders;
  }


  public void setCopiedPlaceholders(List<DocumentTemplateResponseCopiedPlaceholdersInner> copiedPlaceholders) {
  ...
  public DocumentTemplateResponse status(String status) {
  ...
  **/
  ...
  public DocumentTemplateResponse reminders(Boolean reminders) {
  ...
  **/
  ...
  public DocumentTemplateResponse archived(Boolean archived) {
  ...
  **/
  ...
  public DocumentTemplateResponse templateLink(String templateLink) {
  ...
  **/
  ...
  public DocumentTemplateResponse applySigningOrder(Boolean applySigningOrder) {
  ...
  **/
  ...
  public DocumentTemplateResponse redirectUrl(String redirectUrl) {
  ...
  **/
  ...
  public DocumentTemplateResponse declineRedirectUrl(String declineRedirectUrl) {
  ...
  **/
  ...
  public DocumentTemplateResponse expiresIn(Integer expiresIn) {
  ...
  **/
  ...
  public DocumentTemplateResponse files(List<DocumentResponseFilesInner> files) {
  ...
  public DocumentTemplateResponse addFilesItem(DocumentResponseFilesInner filesItem) {
    if (this.files == null) {
  ...
  **/
  ...
  public DocumentTemplateResponse fields(List<List<DocumentResponseFieldsInnerInner>> fields) {
  ...
  public DocumentTemplateResponse addFieldsItem(List<DocumentResponseFieldsInnerInner> fieldsItem) {
    if (this.fields == null) {
  ...
  **/
  ...
  public List<List<DocumentResponseFieldsInnerInner>> getFields() {
    return fields;
  }


  public void setFields(List<List<DocumentResponseFieldsInnerInner>> fields) {
  ...
  public DocumentTemplateResponse allowDecline(Boolean allowDecline) {
  ...
  **/
  ...
  public DocumentTemplateResponse allowReassign(Boolean allowReassign) {
  ...
  **/
   ...
   * @return the DocumentTemplateResponse instance itself
   */
  public DocumentTemplateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentTemplateResponse documentTemplateResponse = (DocumentTemplateResponse) o;
    return Objects.equals(this.id, documentTemplateResponse.id) &&
        Objects.equals(this.apiApplicationId, documentTemplateResponse.apiApplicationId) &&
        Objects.equals(this.requesterEmailAddress, documentTemplateResponse.requesterEmailAddress) &&
        Objects.equals(this.customRequesterName, documentTemplateResponse.customRequesterName) &&
        Objects.equals(this.customRequesterEmail, documentTemplateResponse.customRequesterEmail) &&
        Objects.equals(this.name, documentTemplateResponse.name) &&
        Objects.equals(this.subject, documentTemplateResponse.subject) &&
        Objects.equals(this.message, documentTemplateResponse.message) &&
        Objects.equals(this.metadata, documentTemplateResponse.metadata) &&
        Objects.equals(this.createdAt, documentTemplateResponse.createdAt) &&
        Objects.equals(this.updatedAt, documentTemplateResponse.updatedAt) &&
        Objects.equals(this.placeholders, documentTemplateResponse.placeholders) &&
        Objects.equals(this.copiedPlaceholders, documentTemplateResponse.copiedPlaceholders) &&
        Objects.equals(this.status, documentTemplateResponse.status) &&
        Objects.equals(this.reminders, documentTemplateResponse.reminders) &&
        Objects.equals(this.archived, documentTemplateResponse.archived) &&
        Objects.equals(this.templateLink, documentTemplateResponse.templateLink) &&
        Objects.equals(this.applySigningOrder, documentTemplateResponse.applySigningOrder) &&
        Objects.equals(this.redirectUrl, documentTemplateResponse.redirectUrl) &&
        Objects.equals(this.declineRedirectUrl, documentTemplateResponse.declineRedirectUrl) &&
        Objects.equals(this.expiresIn, documentTemplateResponse.expiresIn) &&
        Objects.equals(this.files, documentTemplateResponse.files) &&
        Objects.equals(this.fields, documentTemplateResponse.fields) &&
        Objects.equals(this.allowDecline, documentTemplateResponse.allowDecline) &&
        Objects.equals(this.allowReassign, documentTemplateResponse.allowReassign)&&
        Objects.equals(this.additionalProperties, documentTemplateResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, apiApplicationId, requesterEmailAddress, customRequesterName, customRequesterEmail, name, subject, message, metadata, createdAt, updatedAt, placeholders, copiedPlaceholders, status, reminders, archived, templateLink, applySigningOrder, redirectUrl, declineRedirectUrl, expiresIn, files, fields, allowDecline, allowReassign, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DocumentTemplateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DocumentTemplateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentTemplateResponse is not found in the empty JSON string", DocumentTemplateResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentTemplateResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("placeholders") != null && !jsonObj.get("placeholders").isJsonNull()) {
        ...
        if (jsonArrayplaceholders != null) {
          ...
          for (int i = 0; i < jsonArrayplaceholders.size(); i++) {
            DocumentTemplateResponsePlaceholdersInner.validateJsonObject(jsonArrayplaceholders.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("copied_placeholders") != null && !jsonObj.get("copied_placeholders").isJsonNull()) {
        ...
        if (jsonArraycopiedPlaceholders != null) {
          ...
          for (int i = 0; i < jsonArraycopiedPlaceholders.size(); i++) {
            DocumentTemplateResponseCopiedPlaceholdersInner.validateJsonObject(jsonArraycopiedPlaceholders.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentTemplateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentTemplateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentTemplateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentTemplateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentTemplateResponse>() {
           @Override
           public void write(JsonWriter out, DocumentTemplateResponse value) throws IOException {
           ...
           @Override
           public DocumentTemplateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DocumentTemplateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DocumentTemplateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DocumentTemplateResponse
  * @throws IOException if the JSON string is invalid with respect to DocumentTemplateResponse
  */
  public static DocumentTemplateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentTemplateResponse.class);
  }

 /**
  * Convert an instance of DocumentTemplateResponse to an JSON string
  *
  * @return JSON string
  */
