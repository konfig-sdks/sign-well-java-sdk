...
public class FieldsForTemplateMapInnerInner {
  ...
  public static final String SERIALIZED_NAME_PLACEHOLDER_ID = "placeholder_id";
  @SerializedName(SERIALIZED_NAME_PLACEHOLDER_ID)
 ...
 public enum DateFormatEnum {
  ...
  public FieldsForTemplateMapInnerInner() {
  }

  public FieldsForTemplateMapInnerInner x(Float x) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner y(Float y) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner page(Integer page) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner placeholderId(String placeholderId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Unique identifier of the placeholder assigned to the field.")
  ...
  public FieldsForTemplateMapInnerInner type(TypeEnum type) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner required(Boolean required) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner label(String label) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner value(Object value) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner apiId(String apiId) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner validation(ValidationEnum validation) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner fixedWidth(Boolean fixedWidth) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner lockSignDate(Boolean lockSignDate) {
  ...
  **/
  ...
  public FieldsForTemplateMapInnerInner dateFormat(DateFormatEnum dateFormat) {
  ...
  **/
   ...
   * @return the FieldsForTemplateMapInnerInner instance itself
   */
  public FieldsForTemplateMapInnerInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FieldsForTemplateMapInnerInner fieldsForTemplateMapInnerInner = (FieldsForTemplateMapInnerInner) o;
    return Objects.equals(this.x, fieldsForTemplateMapInnerInner.x) &&
        Objects.equals(this.y, fieldsForTemplateMapInnerInner.y) &&
        Objects.equals(this.page, fieldsForTemplateMapInnerInner.page) &&
        Objects.equals(this.placeholderId, fieldsForTemplateMapInnerInner.placeholderId) &&
        Objects.equals(this.type, fieldsForTemplateMapInnerInner.type) &&
        Objects.equals(this.required, fieldsForTemplateMapInnerInner.required) &&
        Objects.equals(this.label, fieldsForTemplateMapInnerInner.label) &&
        Objects.equals(this.value, fieldsForTemplateMapInnerInner.value) &&
        Objects.equals(this.apiId, fieldsForTemplateMapInnerInner.apiId) &&
        Objects.equals(this.validation, fieldsForTemplateMapInnerInner.validation) &&
        Objects.equals(this.fixedWidth, fieldsForTemplateMapInnerInner.fixedWidth) &&
        Objects.equals(this.lockSignDate, fieldsForTemplateMapInnerInner.lockSignDate) &&
        Objects.equals(this.dateFormat, fieldsForTemplateMapInnerInner.dateFormat)&&
        Objects.equals(this.additionalProperties, fieldsForTemplateMapInnerInner.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(x, y, page, placeholderId, type, required, label, value, apiId, validation, fixedWidth, lockSignDate, dateFormat, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FieldsForTemplateMapInnerInner {\n");
  ...
  static {
    ...
    openapiFields.add("placeholder_id");
    ...
    openapiRequiredFields.add("placeholder_id");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FieldsForTemplateMapInnerInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldsForTemplateMapInnerInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FieldsForTemplateMapInnerInner is not found in the empty JSON string", FieldsForTemplateMapInnerInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FieldsForTemplateMapInnerInner.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("placeholder_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `placeholder_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("placeholder_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FieldsForTemplateMapInnerInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FieldsForTemplateMapInnerInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FieldsForTemplateMapInnerInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FieldsForTemplateMapInnerInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FieldsForTemplateMapInnerInner>() {
           @Override
           public void write(JsonWriter out, FieldsForTemplateMapInnerInner value) throws IOException {
           ...
           @Override
           public FieldsForTemplateMapInnerInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FieldsForTemplateMapInnerInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FieldsForTemplateMapInnerInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FieldsForTemplateMapInnerInner
  * @throws IOException if the JSON string is invalid with respect to FieldsForTemplateMapInnerInner
  */
  public static FieldsForTemplateMapInnerInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FieldsForTemplateMapInnerInner.class);
  }

 /**
  * Convert an instance of FieldsForTemplateMapInnerInner to an JSON string
  *
  * @return JSON string
  */
